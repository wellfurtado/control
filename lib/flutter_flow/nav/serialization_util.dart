    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case UnidadecargoRow:
            return UnidadecargoRow(data);
          case CodigoRow:
            return CodigoRow(data);
          case UsuarioRow:
            return UsuarioRow(data);
          case UnidadecontratoRow:
            return UnidadecontratoRow(data);
          case AfilhadoRow:
            return AfilhadoRow(data);
          case ContratosRow:
            return ContratosRow(data);
          case CargosRow:
            return CargosRow(data);
          case DetalhesunidadeRow:
            return DetalhesunidadeRow(data);
          case PadrinhoRow:
            return PadrinhoRow(data);
          case ValoresRow:
            return ValoresRow(data);
          case OcupacaoRow:
            return OcupacaoRow(data);
          default:
            return null;
        }
