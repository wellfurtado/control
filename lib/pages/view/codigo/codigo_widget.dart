...
import '/components/edit_codigo/edit_codigo_widget.dart';
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: FutureBuilder<List<CodigoRow>>(
                                          future: (_model.requestCompleter ??=
                                                  Completer<List<CodigoRow>>()
                                                    ..complete(
                                                        CodigoTable().queryRows(
                                                      queryFn: (q) => q,
                                                    )))
                                              .future,
                                          builder: (context, snapshot) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemCount:
                                                  listViewCodigoRowList.length,
                                              itemBuilder:
                                                  (context, listViewIndex) {
                                                final listViewCodigoRow =
                                                    listViewCodigoRowList[
                                                        listViewIndex];
                                                return Padding(
                                                  padding: const EdgeInsetsDirectional
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: SizedBox(
                                                                                ...
                                                                                child: EditCodigoWidget(
                                                                                  parametroEditCodigo: listViewCodigoRow,
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
