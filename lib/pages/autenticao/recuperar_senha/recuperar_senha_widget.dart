...
class _RecuperarSenhaWidgetState extends State<RecuperarSenhaWidget>
  ...
  void initState() {
    ...
    _model.emaiRecuperarController ??= TextEditingController();
    _model.emaiRecuperarFocusNode ??= FocusNode();
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      16.0, 20.0, 16.0, 0.0),
                                  child: Text(
                                    'Será enviado um link no seu email para redefinir sua senha. Por favor coloque o email associado a sua conta.',
                                    style:
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 20.0, 16.0, 0.0),
                            child: TextFormField(
                              controller: _model.emaiRecuperarController,
                              focusNode: _model.emaiRecuperarFocusNode,
                              autofocus: true,
                              obscureText: false,
                              ...
                              validator: _model.emaiRecuperarControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if (_model
                                        .emaiRecuperarController.text.isEmpty) {
                                    ...
                                    await authManager.resetPassword(
                                      email:
                                          _model.emaiRecuperarController.text,
                                      context: context,
                                    );
                                  },
                                  text: 'Enviar link',
