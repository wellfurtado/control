...
import 'add_afilhado_unidade_widget.dart' show AddAfilhadoUnidadeWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AddAfilhadoUnidadeModel
    extends FlutterFlowModel<AddAfilhadoUnidadeWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addAfilhadoUnidade widget.
  ApiCallResponse? outUnidad;
  // Stores action output result for [Backend Call - API (Consulta Ocupacao)] action in addAfilhadoUnidade widget.
  ApiCallResponse? outOcupacao;
  // Stores action output result for [Backend Call - API (Consulta Padrinho)] action in addAfilhadoUnidade widget.
