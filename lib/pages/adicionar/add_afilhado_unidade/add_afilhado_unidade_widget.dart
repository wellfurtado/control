...
import 'add_afilhado_unidade_model.dart';
export 'add_afilhado_unidade_model.dart';

class AddAfilhadoUnidadeWidget extends StatefulWidget {
  const AddAfilhadoUnidadeWidget({
    super.key,
    this.paramAfilhadoUnidade,
  });

  final UnidadeRow? paramAfilhadoUnidade;

  @override
  _AddAfilhadoUnidadeWidgetState createState() =>
      _AddAfilhadoUnidadeWidgetState();
}

class _AddAfilhadoUnidadeWidgetState extends State<AddAfilhadoUnidadeWidget>
    with TickerProviderStateMixin {
  late AddAfilhadoUnidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAfilhadoUnidadeModel());
