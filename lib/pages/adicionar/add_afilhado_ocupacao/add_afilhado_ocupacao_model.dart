...
import 'add_afilhado_ocupacao_widget.dart' show AddAfilhadoOcupacaoWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AddAfilhadoOcupacaoModel
    extends FlutterFlowModel<AddAfilhadoOcupacaoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addAfilhadoOcupacao widget.
  ApiCallResponse? outUnidad;
  // Stores action output result for [Backend Call - API (Consulta Ocupacao)] action in addAfilhadoOcupacao widget.
  ApiCallResponse? outOcupacao;
  // Stores action output result for [Backend Call - API (Consulta Padrinho)] action in addAfilhadoOcupacao widget.
