...
import 'add_afilhado_ocupacao_model.dart';
export 'add_afilhado_ocupacao_model.dart';

class AddAfilhadoOcupacaoWidget extends StatefulWidget {
  const AddAfilhadoOcupacaoWidget({
    super.key,
    this.paramAfilhadoOcupacao,
  });

  final OcupacaoRow? paramAfilhadoOcupacao;

  @override
  _AddAfilhadoOcupacaoWidgetState createState() =>
      _AddAfilhadoOcupacaoWidgetState();
}

class _AddAfilhadoOcupacaoWidgetState extends State<AddAfilhadoOcupacaoWidget>
    with TickerProviderStateMixin {
  late AddAfilhadoOcupacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAfilhadoOcupacaoModel());
