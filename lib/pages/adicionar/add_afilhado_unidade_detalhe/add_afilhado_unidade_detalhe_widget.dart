...
import 'add_afilhado_unidade_detalhe_model.dart';
export 'add_afilhado_unidade_detalhe_model.dart';

class AddAfilhadoUnidadeDetalheWidget extends StatefulWidget {
  const AddAfilhadoUnidadeDetalheWidget({
    super.key,
    this.paramAfilhadoUnidadeDetalhe,
  });

  final UnidadeRow? paramAfilhadoUnidadeDetalhe;

  @override
  _AddAfilhadoUnidadeDetalheWidgetState createState() =>
      _AddAfilhadoUnidadeDetalheWidgetState();
}

class _AddAfilhadoUnidadeDetalheWidgetState
    extends State<AddAfilhadoUnidadeDetalheWidget>
    with TickerProviderStateMixin {
  late AddAfilhadoUnidadeDetalheModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAfilhadoUnidadeDetalheModel());
