...
import 'add_afilhado_padrinho_widget.dart' show AddAfilhadoPadrinhoWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AddAfilhadoPadrinhoModel
    extends FlutterFlowModel<AddAfilhadoPadrinhoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addAfilhadoPadrinho widget.
  ApiCallResponse? outUnidad;
  // Stores action output result for [Backend Call - API (Consulta Ocupacao)] action in addAfilhadoPadrinho widget.
  ApiCallResponse? outOcupacao;
  // Stores action output result for [Backend Call - API (Consulta Padrinho)] action in addAfilhadoPadrinho widget.
