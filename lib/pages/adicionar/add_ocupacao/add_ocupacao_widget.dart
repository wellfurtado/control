...
import 'add_ocupacao_model.dart';
export 'add_ocupacao_model.dart';

class AddOcupacaoWidget extends StatefulWidget {
  const AddOcupacaoWidget({super.key});

  @override
  _AddOcupacaoWidgetState createState() => _AddOcupacaoWidgetState();
}

class _AddOcupacaoWidgetState extends State<AddOcupacaoWidget>
    with TickerProviderStateMixin {
  late AddOcupacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddOcupacaoModel());
