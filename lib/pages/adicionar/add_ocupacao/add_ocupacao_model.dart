...
import 'add_ocupacao_widget.dart' show AddOcupacaoWidget;
import 'package:flutter/material.dart';

class AddOcupacaoModel extends FlutterFlowModel<AddOcupacaoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Codigo)] action in addOcupacao widget.
  ApiCallResponse? outCodigo;
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addOcupacao widget.
