...
import 'add_ocupacao_unidade_detalhe_widget.dart'
    show AddOcupacaoUnidadeDetalheWidget;
import 'package:flutter/material.dart';

class AddOcupacaoUnidadeDetalheModel
    extends FlutterFlowModel<AddOcupacaoUnidadeDetalheWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Codigo)] action in addOcupacaoUnidadeDetalhe widget.
  ApiCallResponse? outCodigo;
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addOcupacaoUnidadeDetalhe widget.
