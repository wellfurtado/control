...
import 'add_ocupacao_unidade_model.dart';
export 'add_ocupacao_unidade_model.dart';

class AddOcupacaoUnidadeWidget extends StatefulWidget {
  const AddOcupacaoUnidadeWidget({
    super.key,
    this.paramOcupacaoUnidade,
  });

  final UnidadeRow? paramOcupacaoUnidade;

  @override
  _AddOcupacaoUnidadeWidgetState createState() =>
      _AddOcupacaoUnidadeWidgetState();
}

class _AddOcupacaoUnidadeWidgetState extends State<AddOcupacaoUnidadeWidget>
    with TickerProviderStateMixin {
  late AddOcupacaoUnidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddOcupacaoUnidadeModel());
