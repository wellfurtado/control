...
import 'add_afilhado_model.dart';
export 'add_afilhado_model.dart';

class AddAfilhadoWidget extends StatefulWidget {
  const AddAfilhadoWidget({super.key});

  @override
  _AddAfilhadoWidgetState createState() => _AddAfilhadoWidgetState();
}

class _AddAfilhadoWidgetState extends State<AddAfilhadoWidget>
    with TickerProviderStateMixin {
  late AddAfilhadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAfilhadoModel());
