...
import 'add_afilhado_widget.dart' show AddAfilhadoWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AddAfilhadoModel extends FlutterFlowModel<AddAfilhadoWidget> {
  ...
  // Stores action output result for [Backend Call - API (Consulta Unidade)] action in addAfilhado widget.
  ApiCallResponse? outUnidad;
  // Stores action output result for [Backend Call - API (Consulta Ocupacao)] action in addAfilhado widget.
  ApiCallResponse? outOcupacao;
  // Stores action output result for [Backend Call - API (Consulta Padrinho)] action in addAfilhado widget.
