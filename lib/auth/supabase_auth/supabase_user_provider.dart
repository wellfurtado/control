...
class ControlSupabaseUser extends BaseAuthUser {
  ControlSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> controlSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ControlSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
